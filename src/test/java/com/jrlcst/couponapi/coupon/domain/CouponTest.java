...
class CouponTest {
    ...
    void shouldValidateParamsOnReconstitute() {
        ...
        assertThrows(IllegalArgumentException.class, () -> Coupon.reconstitute(null, code, "Desc", discount, expirationDate, true, false, false, null));
        assertThrows(IllegalArgumentException.class, () -> Coupon.reconstitute(id, null, "Desc", discount, expirationDate, true, false, false, null));
        assertThrows(InvalidCouponDescriptionException.class, () -> Coupon.reconstitute(id, code, null, discount, expirationDate, true, false, false, null));
        assertThrows(InvalidCouponDescriptionException.class, () -> Coupon.reconstitute(id, code, " ", discount, expirationDate, true, false, false, null));
        assertThrows(IllegalArgumentException.class, () -> Coupon.reconstitute(id, code, "Desc", null, expirationDate, true, false, false, null));
        assertThrows(InvalidExpirationDateException.class, () -> Coupon.reconstitute(id, code, "Desc", discount, null, true, false, false, null));
    }
